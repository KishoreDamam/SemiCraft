...
| Next | P3-03 sim sandbox service (/api/v2/simulate + frontend Run button) and/or P3-04 directed-TB generator (can adopt ResetSeq + assertions wiring) | 2-agent budget per session |
