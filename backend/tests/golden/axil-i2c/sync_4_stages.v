// SemiCraft v0.3.0
// Snippet: axil_i2c (config hash: ece29f636fdd)
...
module axil_i2c (
    ...
    reg scl_sync2;  // SCL synchroniser
    reg scl_sync3;  // SCL synchroniser
    reg sda_sync0;  // SDA synchroniser
    reg sda_sync1;  // SDA synchroniser
    reg sda_sync2;  // SDA synchroniser
    reg sda_sync3;  // SDA synchroniser
