// SemiCraft v0.3.0
// Snippet: axil_spi (config hash: bc91e43476e8)
// AXI4-Lite SPI master, mode 01
//
...
module axil_spi (
    ...
    output wire        sclk,       // Serial clock, idles 0
    ...
    reg [6:0] rx_shift;  // Receive shift register, fills from the LSB
