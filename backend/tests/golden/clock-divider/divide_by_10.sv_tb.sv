// SemiCraft v0.1.0
// Testbench: clock_divider_tb (config hash: 2ea29f4eb8dd)
    ...
    initial begin
        ...
        fork
            begin
                ...
                $fatal(1, "TIMEOUT: clock_divider_tb exceeded 224 cycles");
            end
        join_none
        ...
        if (clk_out !== 1'd1) begin
            $fatal(1, "SMOKE FAIL: clk_out at cycle 5 expected 1, got %0d", clk_out);
        end
