// SemiCraft v0.1.0
// Testbench: clock_divider_tb (config hash: d48127030ad4)
    ...
    initial begin
        ...
        fork
            begin
                ...
                for (watchdog_i = 0; watchdog_i < 8344; watchdog_i++) @(posedge clk);
        ...
        if (clk_out !== 1'd1) begin
            $fatal(1, "SMOKE FAIL: clk_out at cycle 1024 expected 1, got %0d", clk_out);
        end
