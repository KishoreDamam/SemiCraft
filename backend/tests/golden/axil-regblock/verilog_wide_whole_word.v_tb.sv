// SemiCraft v0.4.0
// Testbench: axil_regblock_tb (config hash: aab4a66797fe)
...
module axil_regblock_tb;
    ...
    logic rvalid;
    logic rready;
    logic [63:0] ctrl0_value;
    logic [63:0] status0_value;
    logic [63:0] irq0_value;
    logic [63:0] irq0_value_set;
    logic [63:0] cmd0_value;
    ...
    initial begin
        ...
        awvalid = 1'd1;
        bready = 1'd1;
        wdata = 64'd18446744073709551615;
        wstrb = 8'd255;
        wvalid = 1'd1;
        @(negedge aclk);
        awvalid = 1'd0;
        ...
        if (ctrl0_value !== 64'd18446744073709551615) begin
            $fatal(1, "SMOKE FAIL: ctrl0_value at cycle 3 expected 18446744073709551615, got %0d", ctrl0_value);
        end
        @(negedge aclk);
        araddr = 6'd0;
        arvalid = 1'd1;
        ...
        if (rdata !== 64'd18446744073709551615) begin
            $fatal(1, "SMOKE FAIL: rdata at cycle 5 expected 18446744073709551615, got %0d", rdata);
        end
        if (rresp !== 2'd0) begin
        ...
        @(negedge aclk);
        irq0_value_set = 64'd18446744073709551615;
        @(negedge aclk);
        irq0_value_set = 64'd0;
        #1;
        if (irq0_value !== 64'd18446744073709551615) begin
            $fatal(1, "SMOKE FAIL: irq0_value at cycle 9 expected 18446744073709551615, got %0d", irq0_value);
        end
        @(negedge aclk);
        awaddr = 6'd16;
        awvalid = 1'd1;
        bready = 1'd1;
        wdata = 64'd9223372036854775808;
        wstrb = 8'd255;
        wvalid = 1'd1;
        @(negedge aclk);
        awvalid = 1'd0;
        ...
        if (irq0_value !== 64'd9223372036854775807) begin
            $fatal(1, "SMOKE FAIL: irq0_value at cycle 12 expected 9223372036854775807, got %0d", irq0_value);
        end
        @(negedge aclk);
        araddr = 6'd16;
        arvalid = 1'd1;
        ...
        if (rdata !== 64'd9223372036854775807) begin
            $fatal(1, "SMOKE FAIL: rdata at cycle 14 expected 9223372036854775807, got %0d", rdata);
        end
        if (rresp !== 2'd0) begin
        ...
        if (scratch_value !== 64'd11574711341044573863) begin
            $fatal(1, "SMOKE FAIL: scratch_value at cycle 17 expected 11574711341044573863, got %0d", scratch_value);
        end
        @(negedge aclk);
        awaddr = 6'd32;
        awvalid = 1'd1;
        ...
        if (scratch_value !== 64'd11555852212657366616) begin
            $fatal(1, "SMOKE FAIL: scratch_value at cycle 20 expected 11555852212657366616, got %0d", scratch_value);
        end
        @(negedge aclk);
        araddr = 6'd32;
        arvalid = 1'd1;
        ...
        if (rdata !== 64'd11555852212657366616) begin
            $fatal(1, "SMOKE FAIL: rdata at cycle 22 expected 11555852212657366616, got %0d", rdata);
        end
        if (rresp !== 2'd0) begin
        ...
        arvalid = 1'd1;
        rready = 1'd1;
        status0_value = 64'd18446744073709551615;
        @(negedge aclk);
        arvalid = 1'd0;
        #1;
        if (rvalid !== 1'd1) begin
        ...
        if (rdata !== 64'd18446744073709551615) begin
            $fatal(1, "SMOKE FAIL: rdata at cycle 24 expected 18446744073709551615, got %0d", rdata);
        end
        if (rresp !== 2'd0) begin
        ...
        if (cmd0_value !== 64'd18446744073709551615) begin
            $fatal(1, "SMOKE FAIL: cmd0_value at cycle 27 expected 18446744073709551615, got %0d", cmd0_value);
        end
        @(negedge aclk);
        araddr = 6'd24;
        arvalid = 1'd1;
