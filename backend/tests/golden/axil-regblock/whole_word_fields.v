// SemiCraft v0.4.0
// Snippet: axil_regblock (config hash: 763ad261e462)
...
module axil_regblock (
    ...
    output reg  [31:0] ctrl0_value,      // CTRL0.value (RW)
    input  wire [31:0] status0_value,    // STATUS0.value (RO) — sampled on read
    output reg  [31:0] irq0_value,       // IRQ0.value (W1C) — current value
    input  wire [31:0] irq0_value_set,   // IRQ0.value (W1C) — set request; a set beats a same-cycle clear
    output reg  [31:0] cmd0_value,       // CMD0.value (WO) — reads back as 0
