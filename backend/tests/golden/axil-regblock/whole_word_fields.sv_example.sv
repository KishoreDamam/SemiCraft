// SemiCraft v0.4.0
// Example instantiation: axil_regblock (config hash: 45893442ac91)
...
module axil_regblock_example (
    ...
    output logic        rvalid,
    input  logic        rready,
    output logic [31:0] ctrl0_value,
    input  logic [31:0] status0_value,
    output logic [31:0] irq0_value,
    input  logic [31:0] irq0_value_set,
    output logic [31:0] cmd0_value,
