// SemiCraft v0.4.0
// Example instantiation: axil_regblock (config hash: aab4a66797fe)
...
module axil_regblock_example (
    ...
    output wire        rvalid,
    input  wire        rready,
    output wire [63:0] ctrl0_value,
    input  wire [63:0] status0_value,
    output wire [63:0] irq0_value,
    input  wire [63:0] irq0_value_set,
    output wire [63:0] cmd0_value,
    output wire [63:0] scratch_value
);
