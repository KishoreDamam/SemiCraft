// SemiCraft v0.4.0
// Example instantiation: axil_regblock (config hash: 239f6729f170)
...
module axil_regblock_example (
    ...
    output logic        ctrl1_enable,
    output logic [1:0]  ctrl1_mode,
    output logic [3:0]  ctrl1_level,
    input  logic        status0_busy,
    input  logic [3:0]  status0_code,
    input  logic        status1_busy,
    input  logic [3:0]  status1_code,
    output logic [3:0]  irq0_flags,
    input  logic [3:0]  irq0_flags_set,
    output logic [3:0]  irq1_flags,
    input  logic [3:0]  irq1_flags_set,
    output logic        cmd0_go,
    output logic [2:0]  cmd0_code,
    output logic        cmd1_go,
    output logic [2:0]  cmd1_code,
