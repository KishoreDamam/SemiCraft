// SemiCraft v0.4.0
// Snippet: axil_gpio (config hash: 06b21227b805)
...
module axil_gpio (
    ...
    input  wire [12:0] gpio_in,    // Asynchronous pin inputs
    output wire [12:0] gpio_out,   // Pin output values
    output wire [12:0] gpio_oe     // Pin output enables (1 = drive)
);

    reg [12:0] dir_value;  // DIR.value (RW)
    reg [12:0] out_value;  // OUT.value (RW)
    wire [12:0] in_value;  // IN.value (RO) — sampled on read
    ...
    reg [12:0] in_sync0;  // Input synchroniser stage 0
    reg [12:0] in_sync1;  // Input synchroniser stage 1
