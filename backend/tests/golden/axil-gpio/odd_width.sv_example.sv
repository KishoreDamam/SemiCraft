// SemiCraft v0.4.0
// Example instantiation: axil_gpio (config hash: bc2d452f2b0e)
// An AXI4-Lite GPIO controller for 13 pin(s).
//
...
module axil_gpio_example (
    ...
    output logic        rvalid,
    input  logic        rready,
    input  logic [12:0] gpio_in,
    output logic [12:0] gpio_out,
    output logic [12:0] gpio_oe
);
