// SemiCraft v0.3.0
// Snippet: axil_gpio (config hash: 65f7f1db0ad7)
...
module axil_gpio (
    ...
    input  wire [31:0] gpio_in,    // Asynchronous pin inputs
    output wire [31:0] gpio_out,   // Pin output values
    output wire [31:0] gpio_oe     // Pin output enables (1 = drive)
);

    reg [31:0] dir_value;  // DIR.value (RW)
    reg [31:0] out_value;  // OUT.value (RW)
    wire [31:0] in_value;  // IN.value (RO) — sampled on read
    ...
    reg [31:0] in_sync0;  // Input synchroniser stage 0
    reg [31:0] in_sync1;  // Input synchroniser stage 1
