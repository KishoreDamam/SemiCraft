// SemiCraft v0.4.0
// Snippet: axil_gpio (config hash: 0cdcdef66c1f)
...
module axil_gpio (
    ...
    input  logic [7:0]  gpio_in,    // Asynchronous pin inputs
    output logic [7:0]  gpio_out,   // Pin output values
    output logic [7:0]  gpio_oe     // Pin output enables (1 = drive)
);

    logic [7:0] dir_value;  // DIR.value (RW)
    logic [7:0] out_value;  // OUT.value (RW)
    logic [7:0] in_value;  // IN.value (RO) — sampled on read
    ...
    logic [7:0] in_sync0;  // Input synchroniser stage 0
    logic [7:0] in_sync1;  // Input synchroniser stage 1
    logic [7:0] in_sync2;  // Input synchroniser stage 2
    logic [7:0] in_sync3;  // Input synchroniser stage 3
