// SemiCraft v0.1.0
// Snippet: mux (config hash: 37675502df01)
...
module mux #(
    ...
    input  logic [WIDTH-1:0]     in8,    // Data input in8
    input  logic [WIDTH-1:0]     in9,    // Data input in9
    input  logic [WIDTH-1:0]     in10,   // Data input in10
    input  logic [WIDTH-1:0]     in11,   // Data input in11
    input  logic [WIDTH-1:0]     in12,   // Data input in12
    input  logic [WIDTH-1:0]     in13,   // Data input in13
    input  logic [WIDTH-1:0]     in14,   // Data input in14
    input  logic [WIDTH-1:0]     in15,   // Data input in15
