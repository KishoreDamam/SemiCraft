// SemiCraft v0.1.0
// Snippet: rr_arbiter (config hash: 7fbc1e551b68)
// 4-way round-robin arbiter, registered grant, hold-grant
//
...
module rr_arbiter (
    ...
    output logic [3:0] grant,        // One-hot grant (zero when idle), registered
