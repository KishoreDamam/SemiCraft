// SemiCraft v0.1.0
// Snippet: rr_arbiter (config hash: 789b6123d07e)
// 8-way round-robin arbiter, combinational grant, hold-grant
//
...
module rr_arbiter (
    ...
    output wire [7:0] grant,        // One-hot grant (zero when idle), combinational
