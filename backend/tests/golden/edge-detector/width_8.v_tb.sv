// SemiCraft v0.1.0
// Testbench: edge_detector_tb (config hash: a767fa943c3a)
...
module edge_detector_tb;
    ...
    initial begin
        ...
        d = 8'd255;
        #1;
        if (pulse !== 8'd255) begin
            $fatal(1, "SMOKE FAIL: pulse at cycle 2 expected 255, got %0d", pulse);
        end
        @(negedge clk);
        d = 8'd0;
        #1;
    ...
    pulse_reset_value: assert property (@(posedge clk) $rose(rst_n) |-> pulse == 8'd0)
