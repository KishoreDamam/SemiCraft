// SemiCraft v0.3.0
// Testbench: lfsr_tb (config hash: 083102ad810f)
...
module lfsr_tb;
    ...
    initial begin
        ...
        en = 1'd1;
        #1;
        if (q !== 32'd3758096384) begin
            $fatal(1, "SMOKE FAIL: q at cycle 4 expected 3758096384, got %0d", q);
        end
        @(negedge clk);
        en = 1'd1;
    ...
    q_reset_value: assert property (@(posedge clk) $rose(rst_n) |-> q == 32'd1)
