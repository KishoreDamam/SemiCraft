// SemiCraft v0.4.0
// Example instantiation: axil_intc (config hash: 932551a34533)
// An AXI4-Lite interrupt controller aggregating 1 edge-triggered source(s) into one masked request line.
//
