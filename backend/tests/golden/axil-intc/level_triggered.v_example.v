// SemiCraft v0.4.0
// Example instantiation: axil_intc (config hash: 18dd3248edc4)
// An AXI4-Lite interrupt controller aggregating 8 level-triggered source(s) into one masked request line.
//
