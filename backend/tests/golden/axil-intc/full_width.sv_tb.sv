// SemiCraft v0.3.0
// Testbench: axil_intc_tb (config hash: d8dcb12e90a8)
    ...
    initial begin
        ...
        fork
            begin
                ...
                for (watchdog_i = 0; watchdog_i < 584; watchdog_i++) @(posedge aclk);
                $fatal(1, "TIMEOUT: axil_intc_tb exceeded 584 cycles");
            end
        join_none
