// SemiCraft v0.4.0
// Example instantiation: axil_intc (config hash: 75a8ad364387)
// An AXI4-Lite interrupt controller aggregating 8 edge-triggered source(s) into one masked request line.
//
...
module axil_intc_example (
    ...
    input  logic [7:0]  p_irqIn,
    output logic        p_irqOut
);
