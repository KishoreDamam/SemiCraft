// SemiCraft v0.4.0
// Example instantiation: axil_intc (config hash: f2ebca9f537b)
// An AXI4-Lite interrupt controller aggregating 13 edge-triggered source(s) into one masked request line.
//
