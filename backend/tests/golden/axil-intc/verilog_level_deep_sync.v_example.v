// SemiCraft v0.4.0
// Example instantiation: axil_intc (config hash: a56bc587e07c)
// An AXI4-Lite interrupt controller aggregating 24 level-triggered source(s) into one masked request line.
//
