// SemiCraft v0.3.0
// Testbench: debouncer_tb (config hash: 9b0c957bd815)
...
module debouncer_tb;
    ...
    initial begin
        ...
        #1;
        if (q !== 1'd0) begin
            $fatal(1, "SMOKE FAIL: q at cycle 7 expected 0, got %0d", q);
        end
    ...
    q_reset_value: assert property (@(posedge clk) $fell(rst) |-> q == 1'd0)
