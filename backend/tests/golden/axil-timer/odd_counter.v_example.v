// SemiCraft v0.4.0
// Example instantiation: axil_timer (config hash: 45f666a6b61c)
// An AXI4-Lite timer with a 20-bit down-counter and a 16-bit prescaler, running one-shot or periodically and raising a maskable interrupt on expiry.
//
