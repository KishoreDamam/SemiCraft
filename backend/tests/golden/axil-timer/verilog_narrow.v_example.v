// SemiCraft v0.4.0
// Example instantiation: axil_timer (config hash: 1463b2513a5c)
// An AXI4-Lite timer with a 16-bit down-counter and a 8-bit prescaler, running one-shot or periodically and raising a maskable interrupt on expiry.
//
