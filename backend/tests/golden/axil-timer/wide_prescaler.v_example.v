// SemiCraft v0.4.0
// Example instantiation: axil_timer (config hash: ec2eb3d1bf1b)
// An AXI4-Lite timer with a 32-bit down-counter and a 32-bit prescaler, running one-shot or periodically and raising a maskable interrupt on expiry.
//
