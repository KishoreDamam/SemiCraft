// SemiCraft v0.3.0
// Snippet: axil_timer (config hash: dd5df8675121)
...
module axil_timer (
    ...
    assign wr_rsvd_mask = ((((wr_addr_ctrl ? 32'hFFFFFFF8 : 32'b0) | (wr_addr_reload ? 32'h0 : 32'b0)) | (wr_addr_count ? 32'hFFFFFFFF : 32'b0)) | (wr_addr_prescale ? 32'hFFFF0000 : 32'b0)) | (wr_addr_status ? 32'hFFFFFFFE : 32'b0);
