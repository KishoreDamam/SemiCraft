// SemiCraft v0.4.0
// Example instantiation: axil_timer (config hash: c7d6b58fadfd)
// An AXI4-Lite timer with a 32-bit down-counter and a 1-bit prescaler, running one-shot or periodically and raising a maskable interrupt on expiry.
//
